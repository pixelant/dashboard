/**
 * A drag and drop library for a two-dimensional resizable and responsive list of items
 *
...
define('draggableGridList', ['jquery', 'gridList'], function($, GridList) {
	...
	DraggableGridList.prototype = {
		...
		/**
		 * Bind prototype method to instance scope (similar to CoffeeScript's fat arrow)
		 */
