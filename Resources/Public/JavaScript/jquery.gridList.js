define('gridList', [], function(){
	...
	/**
	 * Clone items with a deep level of one.
	 * Items are not referenced but their properties are
	 */
	...
	GridList.prototype = {
		 ...
		 * @param {{x:Number, y:Number}} start Position from which to start the search.
		...
		/**
		 * Mark the grid cells that are occupied by an item.
		 * This prevents items from overlapping in the grid
		 */
