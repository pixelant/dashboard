...
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['dashboard'] = [
    'widgets' => [
        \Pixelant\Dashboard\DashboardWidgets\RssWidget::IDENTIFIER => [
            ...
            'class' => \Pixelant\Dashboard\DashboardWidgets\RssWidget::class,
        ...
        \Pixelant\Dashboard\DashboardWidgets\ActionWidget::IDENTIFIER => [
            ...
            'class' => \Pixelant\Dashboard\DashboardWidgets\ActionWidget::class,
        ...
        \Pixelant\Dashboard\DashboardWidgets\SysNewsWidget::IDENTIFIER => [
            ...
            'class' => \Pixelant\Dashboard\DashboardWidgets\SysNewsWidget::class,
        ...
        \Pixelant\Dashboard\DashboardWidgets\IframeWidget::IDENTIFIER => [
            ...
            'class' => \Pixelant\Dashboard\DashboardWidgets\IframeWidget::class,
